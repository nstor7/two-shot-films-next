 const cobertura = {
    ...
    hero: "/images/cobertura_thumnail.jpg",
    ...
    paquetes: [
      {
        ...
        incluye: [
          "1 video principal de 2 a 5 minutos, en formato horizontal, mostrando los mejores momentos de tu evento.",
          "2 versiones adaptadas para redes sociales.",
          "Música licenciada libre de derechos",
          "Entrega en 3-5 días hábiles",
          "1 ronda de revisiones."
        ],
        noIncluye: [
          "Cobertura a una o varias cámaras de una sección completa o performance dentro del evento.",
          "Efectos visuales complejos",
          "Cambios de locación",
          "Cobertura del Making of del evento.",
          "Equipo técnico adicional (drones, grúas, steadicam, luces, lentes, etc.)",
          "Grabación de sonido avanzado"
        ],
        precio: {
          minimo: 450,
          maximo: 1200,
      ...
      },
      {
        ...
        incluye: [
          "1 video narrativo de 5-10 minutos con estructura editorial completa",
          ...
          "2 versiones de para redes sociales",
        ...
        noIncluye: [
          ...
          "Equipo técnico adicional (drones, grúas, steadicam, luces, lentes, etc.)",
          "Grabación de sonido avanzado", 
          "Prácticas o pre-producción para el evento"
        ],
        precio: {
          minimo: 750,
          maximo: 3500,
    ...
    proceso: [
      ...
      { paso: "Recibe tu Material", descripcion: "Entrega rápida y en los formatos que necesites." },
    ],
    meta: {
      title: "Cobertura de Eventos en Panamá",
